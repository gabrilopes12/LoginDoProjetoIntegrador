 ...
 * @author Bruno
 */
public class Estomâgo extends javax.swing.JFrame {
    ...
    public Estomâgo (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 560, 360, 100));
        ...
        getContentPane().add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 340, 360, 130));
        ...
        getContentPane().add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 560, 360, 110));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ESTOMÂGO.jpg"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(Estomâgo.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) { 
                Fígado figado = new Fígado(id_aluno,contador, usuario);
                figado.setVisible(true);
                this.dispose();
            } else {
                try {
                    procuraPergunta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Estomâgo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new Estomâgo(0,0,usuario).setVisible(true);
            }
