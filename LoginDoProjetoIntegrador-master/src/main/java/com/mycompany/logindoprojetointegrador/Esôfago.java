 ...
 * @author Bruno
 */
public class Esôfago extends javax.swing.JFrame {
    ...
    public Esôfago (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane6, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 350, 360, 120));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ESÔFAGO.jpg"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(Esôfago.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) { 
                Estomâgo estomago = new Estomâgo(id_aluno,contador, usuario);
                estomago.setVisible(true);
                this.dispose();
            } else {
                try {
                    procuraPergunta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Esôfago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new Esôfago(0,0,usuario).setVisible(true);
            }
