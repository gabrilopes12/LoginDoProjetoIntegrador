 ...
 * @author Bruno
 */
public class Pâncreas extends javax.swing.JFrame {
    ...
    public Pâncreas (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        jTextArea2.setPreferredSize(new java.awt.Dimension(514, 212));
        ...
        getContentPane().add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 340, 360, 120));
        ...
        getContentPane().add(jScrollPane5, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 520, 360, 120));
        ...
        getContentPane().add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 520, 360, 120));
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 520, 80, 80));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/PÂNCREAS.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(Pâncreas.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) {
                IntestinoGrosso ig = new IntestinoGrosso(id_aluno,contador, usuario);
                ig.setVisible(true);
                this.dispose();
            } else {
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pâncreas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new Pâncreas(0,0,usuario).setVisible(true);
            }
