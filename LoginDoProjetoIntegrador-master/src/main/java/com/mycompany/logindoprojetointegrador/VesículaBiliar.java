 ...
 * @author Bruno
 */
public class VesículaBiliar extends javax.swing.JFrame {
    ...
    public VesículaBiliar (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/VESÍCULA BILIAR.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(VesículaBiliar.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) {
                Pâncreas pancreas = new Pâncreas(id_aluno,contador, usuario);
                pancreas.setVisible(true);
                this.dispose();
            } else {
                try {
                    procuraPergunta();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VesículaBiliar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new VesículaBiliar(0,0,usuario).setVisible(true);
            }
