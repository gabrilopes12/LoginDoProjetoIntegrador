 ...
 * @author Bruno
 */
public class Fígado extends javax.swing.JFrame {
    ...
    public Fígado (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane7, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 550, 360, 120));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/FÍGADO.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(Fígado.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) { 
                VesículaBiliar vb = new  VesículaBiliar(id_aluno,contador, usuario);
                vb.setVisible(true);
                this.dispose();
            } else {
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fígado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new Fígado(0,0,usuario).setVisible(true);
            }
