 ...
 * @author gabriel
 */
public class TelaRankingProfessor extends javax.swing.JFrame {
    
private Usuario usuario; 
    /**
     * Creates new form TelaRanking
     */
    public TelaRankingProfessor(Usuario usuario) throws Exception{
    ...
    private void initComponents() {
        ...
        getContentPane().add(nome5Label, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 590, 160, 50));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 630, 150, 50));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        telaVerAlunos tl = new telaVerAlunos(usuario);
        tl.setVisible(true);
        this.dispose();
