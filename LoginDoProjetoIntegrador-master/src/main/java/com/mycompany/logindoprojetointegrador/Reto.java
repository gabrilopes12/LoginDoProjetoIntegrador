...
public class Reto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 120, 530, 160));
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/RETO.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(Reto.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) {
                Ânus anus = new Ânus(id_aluno,contador, usuario);
                anus.setVisible(true);
                this.dispose();
            } else {
                try {
                    procuraPergunta();
