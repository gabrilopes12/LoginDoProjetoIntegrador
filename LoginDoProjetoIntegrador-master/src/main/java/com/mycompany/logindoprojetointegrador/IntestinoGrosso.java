 ...
 * @author Bruno
 */
public class IntestinoGrosso extends javax.swing.JFrame {
    ...
    public IntestinoGrosso (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/INTESTINO GROSSO.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(IntestinoGrosso.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) { 
                IntestinoDelgado id = new IntestinoDelgado(id_aluno,contador, usuario);
                id.setVisible(true);
                this.dispose();
            } else {
                try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntestinoGrosso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new IntestinoGrosso(0,0,usuario).setVisible(true);
            }
