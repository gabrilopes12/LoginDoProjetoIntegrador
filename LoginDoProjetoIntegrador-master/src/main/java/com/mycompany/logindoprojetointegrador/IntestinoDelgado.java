 ...
 * @author Bruno
 */
public class IntestinoDelgado extends javax.swing.JFrame {
    ...
    public IntestinoDelgado (int id_aluno, int contador, Usuario usuario) throws Exception {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 150, 530, 160));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/INTESTINO DELGADO.png"))); // NOI18N
    ...
    try {
           ...
           Logger.getLogger(IntestinoDelgado.class.getName()).log(Level.SEVERE, null, ex);
   ...
   //Pegar isso 
    private void validarResposta(int resposta) throws Exception {
        if(resposta == pergunta.pegarResposta()){
            ...
            contador++;
            if(tentativa >= 3) {
                Reto reto = new Reto(id_aluno,contador, usuario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IntestinoDelgado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(Usuario usuario) throws Exception {
                new IntestinoDelgado(0,0,usuario).setVisible(true);
            }
